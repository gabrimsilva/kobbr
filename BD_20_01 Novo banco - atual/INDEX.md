...
3b. **[03b_tables_stock_sales.sql](03b_tables_stock_sales.sql)** 🆕
   - Schema canônico consolidado de stock_items, stock_variants, stock_movements e sales
   - Reúne scripts SQL avulsos divergentes da raiz/migrations
   - Colunas, FKs, índices, triggers e RLS base (pré-multi-tenant)
   - Executar APÓS 03_tables.sql e ANTES de 04_indexes.sql
...
03b_tables_stock_sales.sql → Estoque + Vendas (consolidado) 🆕
