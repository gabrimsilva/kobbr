...
-- ============================================
-- Adicionar campo para indicar se produto precisa de estoque
...
-- ============================================
-- Tabela principal de estoque (1 produto = 1 estoque)
...
-- ============================================
-- Variedades do produto (cor, fragrância, tamanho, etc)
CREATE TABLE IF NOT EXISTS stock_variants (
    ...
    -- Constraint: não pode ter variantes duplicadas no mesmo estoque
...
-- ============================================
-- Recalcula o total_qty baseado nas variantes
...
BEGIN
    ...
    -- Se existirem variantes, recalcular total
...
-- ============================================
-- Quando variante é inserida/atualizada/deletada, recalcular total

CREATE OR REPLACE FUNCTION trigger_recalculate_stock_total()
RETURNS TRIGGER AS $$
BEGIN
    -- Recalcular para o stock_item afetado
...
-- Trigger para INSERT/UPDATE/DELETE em stock_variants
